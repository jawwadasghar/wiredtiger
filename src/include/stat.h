...
struct __wt_connection_stats {
    ...
    int64_t eviction_skip_page_checkpoint_timestamp;
    int64_t eviction_skip_page_prune_timestamp;
    int64_t eviction_skip_stable_trees;
    ...
    int64_t eviction_transaction_blocking;
