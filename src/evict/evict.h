...
#define WT_EVICT_LEVEL_CLEAN_UPDATES 5
#define WT_EVICT_LEVEL_DIRTY_UPDATES 6
#define WT_EVICT_LEVEL_CLEAN_INTERNAL 7
...
static WT_INLINE int __wt_evict_get_bucketset_level(WT_SESSION_IMPL *session, WT_PAGE *page)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
