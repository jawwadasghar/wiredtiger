...
conn_stats = [
    ...
    EvictStat('eviction_skip_checkpointing_trees', 'eviction server skips trees that are being checkpointed'),
    EvictStat('eviction_skip_dirty_pages_during_checkpoint', 'eviction server skips dirty pages during a running checkpoint'),
    EvictStat('eviction_skip_empty_bucket', 'eviction skipped an empty bucket'),
    EvictStat('eviction_skip_history_store_pages_with_updates_during_checkpoint', 'eviction server skips clean history store pages with updates when a precise checkpoint is in progress'),
    EvictStat('eviction_skip_ingest_trees', 'eviction server skips ingest btrees in disagg'),
    ...
    EvictStat('eviction_skip_page_dirty_not_aggressive', 'eviction skips a dirty page, when we are not aggressive'),
    EvictStat('eviction_skip_page_hazard', 'eviction skipped a page, because a hazard pointer was set'),
    EvictStat('eviction_skip_page_last_running', 'eviction skips pages that are written with transactions greater than the last running'),
    EvictStat('eviction_skip_page_locked', 'eviction skipped a page that was locked or evicted'),
    EvictStat('eviction_skip_page_locked_bucket', 'eviction skipped a page, because the bucket was locked'),
    ...
    EvictStat('eviction_target_strategy_updates_only', 'eviction walk target strategy pages with updates'),
