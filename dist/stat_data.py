...
conn_stats = [
    ...
    EvictStat('eviction_pages_set_clean', 'pages transitioned from dirty to clean in eviction state'),
    ...
    EvictStat('eviction_target_strategy_none', 'eviction target strategy neither clean, nor dirty, nor updates'),
    EvictStat('eviction_target_strategy_updates_only', 'eviction target strategy updates only'),
